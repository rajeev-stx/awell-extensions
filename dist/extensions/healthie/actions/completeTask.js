    ...
    onActivityCreated: async (payload, onComplete, onError) => {
        ...
        try {
            ...
            if (client !== undefined) {
                ...
                if (!(0, lodash_1.isNil)((_a = data.updateTask) === null || _a === void 0 ? void 0 : _a.messages)) {
                    const errors = (0, errors_1.mapHealthieToActivityError)((_b = data.updateTask) === null || _b === void 0 ? void 0 : _b.messages);
                    await onError({
                        events: errors,
                    });
                    return;
