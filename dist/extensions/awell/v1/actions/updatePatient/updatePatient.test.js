            ...
            events: expect.arrayContaining([
                expect.objectContaining({
                    error: {
                        ...
                        message: 'Validation error: Value passed is not an email address at "fields.email"',
                    },
                }),
            ]),
        });
        ...
        expect(onError).toHaveBeenCalledWith({
            events: expect.arrayContaining([
                expect.objectContaining({
                    error: {
                        category: 'WRONG_INPUT',
                        message: 'Validation error: Phone number is invalid (NOT_A_NUMBER) at "fields.phone"',
                    },
                }),
            ]),
        });
