...
exports.sendWhatsAppMessage = {
    ...
    onActivityCreated: async (payload, onComplete, onError) => {
        const { fields: { from, to, content }, settings: { apiKey, reportUrl }, } = payload;
        try {
            const allRequiredFieldsHaveValues = [from, to, content].every((field) => !(0, lodash_1.isEmpty)(field));
            ...
            (0, messagebirdSdk_1.default)(apiKey).conversations.send({
                to: String(to),
                from: String(from),
                type: 'text',
                content: {
