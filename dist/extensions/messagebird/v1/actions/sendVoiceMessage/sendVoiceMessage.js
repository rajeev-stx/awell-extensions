...
exports.sendVoiceMessage = void 0;
...
exports.sendVoiceMessage = {
    ...
    onActivityCreated: async (payload, onComplete, onError) => {
        const { fields: { originator, recipient, body, language, voice }, settings: { apiKey }, } = payload;
        try {
            const allRequiredFieldsHaveValues = [recipient, body].every((field) => !(0, lodash_1.isEmpty)(field));
            ...
            (0, messagebirdSdk_1.default)(apiKey).voice_messages.create({
                recipients: [String(recipient)],
                body: String(body),
                language: (0, utils_1.getVoiceLanguage)(language),
                voice: (0, utils_1.getVoice)(voice),
                originator,
...
//# sourceMappingURL=sendVoiceMessage.js.map